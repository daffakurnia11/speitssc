  ...
  <section id="myArticle">
    <div class="container article mt-5">
      <div class="col-lg-9 mx-auto">
        <form action="/myarticle" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                <label for="title" class="form-label fw-bold">Title</label>
                <input type="text" class="form-control" name="title" id="title" placeholder="Your Article Title" value="{{ old('title') }}">
                @error('title')
          ...
          <div class="text-end">
            ...
            <button type="submit" class="article-button">Create Article!</button>
          </div>
        </form>
      </div>
    </div>
